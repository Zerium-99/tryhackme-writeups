...
1. I check if the image file has metadata that can reveal sensitive information. To do this, I'm gonna use exiftool, a tool that lets us see metadatas in files. I ran the following command: 
